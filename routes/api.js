...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'daffaislamy') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'daffaislamy') return res.json(loghandler.invalidKey)
...
router.get('/textmaker/dfabot01', async (req, res, next) => {
...
router.get('/textmaker/dfabotz02', async (req, res, next) => {
        var theme = req.query.theme,
             text = req.query.text,
             text2 = req.query.text2,
             text3 = req.query.text3,
